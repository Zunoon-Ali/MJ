                ...
                <div class="store-main-box">
                    ...
                    <div class="store-card2 store-card1" data-aos="fade-up">
                        <div class="store-card2-image shine">
                            <a href="#">
                                <img src="{{ asset('images/store-card1.jpg') }}" alt="store-card2-img" class="store-card2-img">
                            </a>
                        </div>
                    ...
                    <div class="store-card2 store-card3" data-aos="fade-up">
                        <div class="store-card2-image shine">
                            <a href="#">
                                <img src="{{ asset('images/banner-card2-img.png') }}" alt="store-card2-img" class="store-card2-img">
                            </a>
                        </div>
                        <div class="store-card2-text">
                            <span>Leaf</span>
